...
public class SunWheelController : MonoBehaviour {
    ...
    [SerializeField] private bool telescopeUnlocked = false;

    private List<SunSpike.SunSpikeType> unlockedAbilities = new List<SunSpike.SunSpikeType>();
    private int centerIndex = 0; // Tracks which ability is at center
